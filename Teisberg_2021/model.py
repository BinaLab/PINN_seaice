...
## Create tensorflow function ("@" symbol means)
@tf.function
...
class PINN(tf.keras.Model):
    def __init__(self, config, dataset, gen_model_filename=None):
        ...
        self.smoothing_norm_type = config.get('smoothing_norm_type', 2) # default: square
        self.radar_data_norm_type = config.get('radar_data_loss_norm_type', 2) # default: square
