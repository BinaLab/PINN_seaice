...
class Net(nn.Module):
    def __init__(self, n_filters=32):
        super().__init__()
        self.conv1 = nn.Conv2d(8, n_filters, 5, padding = "same")
        self.conv2 = nn.Conv2d(n_filters, n_filters, 5, padding = "same")
        self.conv3 = nn.Conv2d(n_filters, n_filters, 5, padding = "same")
        self.conv4 = nn.Conv2d(n_filters, n_filters, 5, padding = "same")
        self.conv5 = nn.Conv2d(n_filters, n_filters, 5, padding = "same")
        self.conv6 = nn.Conv2d(n_filters, n_filters, 5, padding = "same")
        self.conv7 = nn.Conv2d(n_filters, n_filters, 5, padding = "same")
        self.conv8 = nn.Conv2d(n_filters, 3, 3, padding = "same")
...
class UNet(nn.Module):
    def __init__(self, n_class=3):
        ...
        # input: 320x320x3
        self.e11 = nn.Conv2d(8, 32, kernel_size=3, padding="same") # output: 320x320x32
